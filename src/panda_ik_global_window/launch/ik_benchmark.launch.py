...
def generate_launch_description() -> LaunchDescription:
    ...
    moveit_cpp_yaml = os.path.join(
        get_package_share_directory("panda_ik_global_window"),
        "config",
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("window_size", default_value="3"),
            ...
            Node(
                package="panda_ik_global_window",
                executable="ik_global_window",
                output="screen",
