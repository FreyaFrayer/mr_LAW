...
def _parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        ...
        description=(
            ...
            "then evaluate window policies for window_size ws=1..N."
        ),
    )
    # MoveIt / robot
...
def main() -> None:
    ...
    try:
        ...
        # For this package, one run evaluates window_size ws = 1..n (ws=1 -> greedy, ws=n -> global).
        ...
        summary = {
            ...
            "meta": {
                ...
                "note": "ws=1 is equivalent to greedy; ws=num_points is equivalent to global.",
            },
            ...
            "window": {
                "ws_min": int(ws_list[0]) if len(ws_list) > 0 else 1,
                "ws_max": int(ws_list[-1]) if len(ws_list) > 0 else int(n),
