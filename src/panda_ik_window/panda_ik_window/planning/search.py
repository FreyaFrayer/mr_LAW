...
def window_path_receding_horizon(
    *,
    ...
    This ensures we never enter the state "remain < ws" during normal operation
    (with ws <= n). When ws == 1, this degenerates to greedy; when ws == n, this
    degenerates to the global optimum.
    """
