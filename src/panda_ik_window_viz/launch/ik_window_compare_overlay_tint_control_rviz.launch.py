...
"""Overlay + tint RViz visualization WITH playback controls.
...
This launch loads an RViz config which includes a custom RViz Panel:
...
def generate_launch_description():
    ...
    default_rviz = os.path.join(pkg_share, "rviz", "ik_window_compare_overlay_tint_control.rviz")
